...
var groceries = ['banana', 'chocolate', 'milk']
...
var groceries = ['banana', 'chocolate', 'milk', item]
...
function checkGroceryCount(){
    return(groceries.length >=5? 'That looks like a big trip': groceries.length +' items')
}
